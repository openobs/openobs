...
export default function PanelEditor({ panel, onSave, onCancel }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 bg-[#111118] rounded-2xl border border-[var(--color-outline-variant)] shadow-xl w-full max-w-2xl mx-4 overflow-hidden flex flex-col max-h-[85vh]">
                  ...
                  {queries.map((q, idx) => (
                    <div key={idx} className="rounded-xl bg-[var(--color-surface-lowest)] border border-[var(--color-outline-variant)] overflow-hidden">
                      <div className="flex items-center gap-2 px-3 py-2 border-b border-[#1E1E2E]">
                        ...
                        {queries.length > 1 && (
                          <button
                            ...
                            className="p-1 rounded text-[var(--color-outline)] hover:text-[#EF5149] hover:bg-[#EF5149]/10 transition-colors"
                          >
                      ...
                      <textarea
                        ...
                        rows={3}
                        spellCheck={false}
                        className="w-full bg-transparent px-3 py-2.5 text-sm text-[var(--color-on-surface)] placeholder:text-[#444454] focus:outline-none resize-none leading-relaxed"
