export { DashboardService, resolvePrometheusDatasource, withDashboardLock } from './dashboard-service.js';
...
export { LiveDashboardGenerator } from './generator-service.js';
export type { DashboardGenerator } from './generator-service.js';
